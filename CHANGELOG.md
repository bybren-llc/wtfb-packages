...
### Fixed
- Fix fountain-js parser integration (was using wrong import/API)
- Validate and export commands now work correctly with Fountain files

### Added
- Test for fountain file validation
...
[1.0.4]: https://github.com/bybren-llc/wtfb-packages/compare/v1.0.3...v1.0.4
